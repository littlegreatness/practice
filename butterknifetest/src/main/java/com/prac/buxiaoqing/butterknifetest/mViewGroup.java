...
/**
 * author：buxiaoqing on 2016/11/11 14:35
...
public class mViewGroup extends ViewGroup {
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        Log.i("tracker", "velocityTraker" + tracker.getXVelocity());
        switch (ev.getAction()) {
    ...
    public boolean onTouchEvent(MotionEvent event) {
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                int targetIndes = (getScrollX() + getWidth() / 2) / getWidth();//这里的计算不能简化，因为会取int型值
                int dx = targetIndes * getWidth() - getScrollX();
