...
import com.prac.buxiaoqing.prac.gif.vediorecord.CameraHelper;
import com.prac.buxiaoqing.prac.gif.vediorecord.CameraPreviewView;
import com.prac.buxiaoqing.prac.gif.vediorecord.FileUtil;
import com.prac.buxiaoqing.prac.gif.vediorecord.WXLikeVideoRecorder;

import java.lang.ref.WeakReference;


public class RecordVedioAct extends Activity implements View.OnTouchListener{

    private String TAG = "RecordVedioAct";
    ...
    public static class StartRecordFailCallbackRunnable implements Runnable {
        ...
        private WeakReference<RecordVedioAct> mNewRecordVideoActivityWeakReference;

        public StartRecordFailCallbackRunnable(RecordVedioAct activity) {
            mNewRecordVideoActivityWeakReference = new WeakReference<>(activity);
        }

        @Override
        public void run() {
            RecordVedioAct activity;
    ...
    public static class StopRecordCallbackRunnable implements Runnable {
        ...
        public StopRecordCallbackRunnable(RecordVedioAct activity) {
            mNewRecordVideoActivityWeakReference = new WeakReference<>(activity);
        }
