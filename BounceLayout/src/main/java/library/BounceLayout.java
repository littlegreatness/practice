...
//			Logger.d(LOG_TAG, "onTouchEvent move");
	...
	protected final void smoothScrollTo(int newScrollValue, BounceScroller.OnSmoothScrollFinishedListener l) {
		this.smoothScrollTo(newScrollValue, 0, l);
	}
	
	protected final void smoothScrollTo(int newScrollValue, int duration, BounceScroller.OnSmoothScrollFinishedListener l) {
		if (mScroller.isFinished()) {
